...
class CLIHandler:
    ...
    def parse_args(self, args=None):
        ...
        parser.add_argument(
            "--upload",
            action="store_true",
            help="Upload record after applying configuration"
        )
        ...
        parser.add_argument(
            "-v", "--validate",
            action="store_true",
            help="Validate configuration only (no upload)"
        )
    ...
    def run(self, args=None) -> int:
        ...
        try:
            ...
            if parsed_args.configs and not parsed_args.validate:
                self.logger.info("Configuration updated. Use --upload to upload or --validate to check.")
