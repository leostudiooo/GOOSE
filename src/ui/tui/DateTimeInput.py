...
class DateTimeInput(Horizontal):
    ...
    def compose(self) -> ComposeResult:
        yield Input(id=f"{self.id_prefix}_date", placeholder="日期 (YYYY-MM-DD)", classes="date-input")
        yield Input(id=f"{self.id_prefix}_time", placeholder="时间 (HH:MM:SS)", classes="time-input")
